...
<!-- Empty slide for starting the title slide along with the talk. -->
...
::: {.dateplace}
18th June 2026 (Maastricht, Netherlands)
:::
...
![](resources/projector-screen-outline.svg){.icon} [slides.mitchelloharawild.com/dad2026](https://slides.mitchelloharawild.com/dad2026)

![](resources/github.svg){.icon} [mitchelloharawild/talk-vecvec-dad2026](https://github.com/mitchelloharawild/talk-vecvec-dad2026)
...
The above calculations are for **confidence intervals**, not prediction intervals! [Did you notice?]{.fragment .fade-in}
:::
:::
:::
:::
...
`{vecvec}` is useful for mixed-type  
vectors with **common semantics**.
:::
